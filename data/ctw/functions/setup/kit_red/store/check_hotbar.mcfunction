...
execute if score slot ctw_inv matches 0..8 unless score slot ctw_inv matches 4 run function ctw:setup/kit_red/store/found_hotbar
execute if score slot ctw_inv matches 4 run function ctw:setup/kit_red/store/override_hotbar_middle